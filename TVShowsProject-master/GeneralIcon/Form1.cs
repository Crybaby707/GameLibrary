...
namespace GeneralIcon
{
    public partial class Form1 : Form
    {
        ...
        {
            // TODO: данная строка кода позволяет загрузить данные в таблицу "tVShowsDataSet1.Contents". При необходимости она может быть перемещена или удалена.
            this.contentsTableAdapter1.Fill(this.tVShowsDataSet1.Contents);
